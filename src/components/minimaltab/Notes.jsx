...
function Notes() {
  const [notes, setNotes] = useLocalStorage("mt.notes", []);
  ...
  return <section aria-labelledby="notes-heading" className="overflow-hidden rounded-2xl border border-border bg-card">
  ...
  >
    ...
    className={`flex w-full items-center gap-1.5 rounded-md px-2 py-1.5 text-left text-xs transition-colors ${activeId === n.id ? "bg-muted text-foreground" : "text-muted-foreground hover:bg-muted/60"}`}
  >
  ...
  />
            ...
            </div> : <div className="flex h-full min-h-[10rem] items-center justify-center text-center">
